...
public class ChromeDriverExtended extends ChromeDriver {

    public ChromeDriverExtended() throws Exception {
        this(new ChromeOptions());
    }

    public ChromeDriverExtended(ChromeOptions options) throws Exception {
        this(ChromeDriverService.createDefaultService(), options);
    }

    public ChromeDriverExtended(ChromeDriverService service, ChromeOptions options) throws Exception {
